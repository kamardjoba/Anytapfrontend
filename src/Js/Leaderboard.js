        ...
        <div className='leaderboardContainer'>
            <div className='blueContainer'>
                <div className='blueContainerItem'>
                    <p className='blueContainerItemTitle'>#{userRank || 'Loadind...'}</p> {/* Отображение ранга */}
                    <p className='blueContainerItemSubtitle'>Your rank</p>
                </div>
                <div className='blueContainerItem'>
                    <p className='blueContainerItemTitle'>{userCoins ? userCoins.toLocaleString() : 'Loadind...'}</p> {/* Отображение монет */}
