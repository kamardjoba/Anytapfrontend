...
function QuestsWithoutCompleted(props) {
    return (
                ...
                <div className='whiteContainerQuest'>
                    ...
                    <div className='questItem'>
                        ...
                        <div className='questItemRight'>
                            <button className='questBtn'>Connect</button>
                        </div>
                    </div>
                    <div className='questItem'>
                        <div className='questItemLeft'>
                    ...
                    <div className='questItem'>
                        <div className='questItemLeft'>
                            ...
                            <div className='questItemLeftContent'>
                                <p className='questTitle'>Subscribe Instagram</p>
                                <p className='questSubtitle'>+200 points</p>
                            </div>
                        </div>
                        <div className='questItemRight'>
...
export default QuestsWithoutCompleted;